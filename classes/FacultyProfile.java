...
public class FacultyProfile implements ActionListener, IFacultyProfile
{
	...
	private String f;
	public FacultyProfile(String user)
	{
		f=user;
		
		frame = new JFrame("MD. MAZID-UL-HAQUE");
		
		ImageIcon framelogo = new ImageIcon("icons/framelogo.jpg");
		ImageIcon faculty = new ImageIcon("icons/FacultyProfile.png");
