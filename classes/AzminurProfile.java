...
public class AzminurProfile implements ActionListener, IAzminurProfile
{
	...
	private String f;
	public AzminurProfile(String user)
	{
		f=user;
		
		frame = new JFrame("AZMINUR RAHMAN");
		
		ImageIcon framelogo = new ImageIcon("icons/framelogo.jpg");
		ImageIcon azminur = new ImageIcon("icons/AzminurProfile.png");
